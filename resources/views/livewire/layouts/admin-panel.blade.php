		...
		<div class="md:pl-64 flex flex-col">
			<div class="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow">
				...
				<div class="flex-1 px-4 flex justify-between">
					...
					{{-- Remove items-center if you re-enable the search field --}}
					<div class="flex-1 flex items-center">

{{--						SEARCH FIELD - DISABLED - COULD BE CONFIGURED --}}
...
{{--						</form>--}}
						...
						{{-- Add mx-auto if you move this down again --}}
					...
					<div class="ml-4 flex items-center md:ml-6">
						...
						<!-- Profile dropdown -->
						<div x-data="{showMenu: false}" @click="showMenu = !showMenu" @click.outside="showMenu = false" class="ml-3 relative">
							<div>
